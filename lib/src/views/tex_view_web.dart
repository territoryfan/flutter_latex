...
import 'package:flutter_latex/src/utils/core_utils.dart';
import 'package:flutter_latex/src/utils/fake_ui.dart'
    ...
    if (getRawData(widget) != _lastData) {
      ui.platformViewRegistry.registerViewFactory(
          ...
          (int id) => html.IFrameElement()
            ..src =
                "assets/packages/flutter_latex/js/${widget.renderingEngine?.name ?? "katex"}/index.html"
            ..id = _viewId
            ..style.border = '0');
